...
ARTIFACT_DEPENDENCY_SUPPORTED_STATUS_COLLECTION = [USER_CODE_FILE_PARSED_STATUS_KEY,
...
ARTIFACT_DEPENDENCY_NOT_SUPPORTED_STATUS_COLLECTION = [USER_CODE_FILE_NOT_PARSED_STATUS_KEY,
